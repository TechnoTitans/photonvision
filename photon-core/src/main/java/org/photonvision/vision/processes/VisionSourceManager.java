...
//                    UsbCamera.enumerateUsbCameras()
                    ...
                    new UsbCameraInfo(1, "/dev/cameras/FR_Apriltag_F", "FR_Apriltag_F", new String[0],  0x045e, 0x0810),
                    new UsbCameraInfo(2, "/dev/cameras/BL_Apriltag_B", "BL_Apriltag_B", new String[0],  0x2560, 0xc128),
                    new UsbCameraInfo(3, "/dev/cameras/drivercam1", "drivercam1", new String[0],  0x0edc, 0x2076)
            );
